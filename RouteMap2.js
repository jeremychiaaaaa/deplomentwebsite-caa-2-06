...
solid and robust foundation. </span>
        ...
        <div style={{justifyContent:'center', display:'flex',width:'1020px',color:'black'}}>
            <p style={{...style,transform:openCard === - 1 && 'translateY(-80px)', opacity:openCard !== - 1 && 0}}>KYN’s dreams and aspirations listed in a humble document. These are the things that keep us up at night and keep us going during the day. It might seem impossible but we are here for a reason. And we are here, to show the world that we will make the impossible possible. Normalcy was never meant for us. WGMI</p>
        </div>
                 </> 
        }  
